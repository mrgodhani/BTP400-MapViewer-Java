      ...
      SimpleTaskHandler<ByteBuffer>() {
        ...
        @Override public void ok(ByteBuffer value, long time, AbstractTask task) {
          ...
          if (_img != null) {
        	  	...
        	  	scrollPane1.remove(imgLbl);
        	  	scrollPane1.add(new JPanel());
  		    	scrollPane1.add(imgLbl,new TableLayoutConstraints(0, 1, 0, 1, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
...
private void initComponents() {
  ...
  //imageMap = new JLabel(new ImageIcon(_img));
  ...
  //======== dialogPane ========
  {
  	...
  	//======== contentPanel ========
  	{
  		...
  		//======== scrollPane1 ========
  		//{
  			scrollPane1.setBorder(new TitledBorder("Map"));
  			scrollPane1.setOpaque(false);
  			//scrollPane1.add(imageMap,new TableLayoutConstraints(3, 2, 3, 2, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
  		    if(_img != null){
  		    	JLabel imgLbl = new JLabel(new ImageIcon(_img));
  		    	scrollPane1.add(imgLbl,new TableLayoutConstraints(0, 1, 0, 1, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
